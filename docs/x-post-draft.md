...
Important caveat: this does not prove the ranking is fair, truthful, or beneficial. It proves that a specific output was bound to specific code, model artifacts, config, and input commitments. Different audit problem.
